...
{
    resize(1024, 520);
    setWindowTitle(tr("MatrixNetwork") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_D));
    tabGroup->addAction(overviewAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive"), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving payments"));
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_R));
    tabGroup->addAction(receiveCoinsAction);

    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send"), this);
    sendCoinsAction->setToolTip(tr("Send coins to a MatrixNetwork address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_S));
    tabGroup->addAction(sendCoinsAction);

    historyAction = new QAction(QIcon(":/icons/history"), tr("&Transactions"), this);
    historyAction->setToolTip(tr("Browse transaction history"));
    historyAction->setCheckable(true);
    historyAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_T));
    tabGroup->addAction(historyAction);

    addressBookAction = new QAction(QIcon(":/icons/address-book"), tr("&Addresses"), this);
    addressBookAction->setToolTip(tr("Edit the list of stored addresses and labels"));
    addressBookAction->setCheckable(true);
    addressBookAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_A));
    ...
    masternodeManagerAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_M));
    tabGroup->addAction(masternodeManagerAction);

    multisigAction = new QAction(QIcon(":/icons/send"), tr("Multisig"), this);
    multisigAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_M));
    tabGroup->addAction(multisigAction);

    showBackupsAction = new QAction(QIcon(":/icons/browse"), tr("Show &AutoBackups"), this);
    showBackupsAction->setStatusTip(tr("Show auto backups."));
    showBackupsAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_A));
    ...
    aboutAction = new QAction(QIcon(":/icons/block"), tr("&About MatrixNetwork"), this);
    aboutAction->setToolTip(tr("Show information about MatrixNetwork"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/block"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for MatrixNetwork"));
    optionsAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_O));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Show / Hide"), this);
    encryptWalletAction = new QAction(QIcon(":/icons/lock_closed"), tr("Encrypt &Wallet..."), this);
    encryptWalletAction->setToolTip(tr("Encrypt or decrypt wallet"));
    encryptWalletAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_W));
    backupWalletAction = new QAction(QIcon(":/icons/filesave"), tr("&Backup Wallet..."), this);
    backupWalletAction->setToolTip(tr("Backup wallet to another location"));
    backupWalletAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_B));
    changePassphraseAction = new QAction(QIcon(":/icons/key"), tr("&Change Passphrase..."), this);
    changePassphraseAction->setToolTip(tr("Change the passphrase used for wallet encryption"));
    changePassphraseAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_C));
    unlockWalletAction = new QAction(QIcon(":/icons/lock_open"), tr("&Unlock Wallet..."), this);
    unlockWalletAction->setToolTip(tr("Unlock wallet"));
    unlockWalletAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_U));
    lockWalletAction = new QAction(QIcon(":/icons/lock_closed"), tr("&Lock Wallet"), this);
    lockWalletAction->setToolTip(tr("Lock wallet"));
    lockWalletAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_L));
    signMessageAction = new QAction(QIcon(":/icons/edit"), tr("&Sign message..."), this);
    signMessageAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_S));
    verifyMessageAction = new QAction(QIcon(":/icons/block"), tr("&Verify message..."), this);
    verifyMessageAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_V));

    exportAction = new QAction(QIcon(":/icons/filesave"),tr("&Export..."), this);
    exportAction->setToolTip(tr("Export the data in the current tab to a file"));
    exportAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_E));
    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"),tr("&Debug window"), this);
    openRPCConsoleAction->setToolTip(tr("Open debugging and diagnostic console"));
    openRPCConsoleAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_D));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("MatrixNetwork client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("MatrixNetwork client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MatrixNetwork network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    else
    {
        ...
        progressBarLabel->setText(clientModel->isImporting() ? tr("Importing blocks...") : tr("Synchronizing with network..."));
...
{
    QString strTitle = tr("MatrixNetwork") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid MatrixNetwork address or malformed URI parameters."));
    }
